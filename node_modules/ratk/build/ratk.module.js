import { Vector3, Group, Matrix4, Mesh, MeshBasicMaterial, Shape, ShapeGeometry, BufferGeometry, BufferAttribute } from 'three';
 ...
 */
class TransformObject extends Group {
    constructor(xrSpace) {
        super();
 ...
 * LICENSE file in the root directory of this source tree.
 */
class HitTestTarget extends Group {
...
export { ARButton, Anchor, HitTestTarget, Plane, RMesh, RealityAccelerator, TransformObject, VRButton };
